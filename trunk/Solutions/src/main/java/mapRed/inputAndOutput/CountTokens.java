...
public class CountTokens extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		NLineInputFormat.setNumLinesPerSplit(job, 2500);
	...
	public static class CountTokensMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
		...
		private final Text countText = new Text("count");
		@Override	
		protected void map(LongWritable key, Text value, Context context)
			...
			while (tokenizer.hasMoreTokens()) {
				context.write(countText, countOne);
				tokenizer.nextToken();
			}
		}
	}
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new CountTokens(), args);
