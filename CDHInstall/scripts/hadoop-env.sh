...
export HADOOP_LOG_DIR=$HADOOP_LOGS/hadoop
export HADOOP_COMMON_HOME=$HADOOP_HOME
export HADOOP_HDFS_HOME=$HADOOP_HOME
export HADOOP_MAPRED_HOME=$HADOOP_HOME
export YARN_HOME=$HADOOP_MAPRED_HOME
export YARN_CONF_DIR=$HADOOP_LOG_DIR
...
export PATH=$PATH:./:/home/hadoop/Training/scripts:$JAVA_HOME/bin:$HADOOP_HOME/bin:$HBASE_HOME/bin:$OOZIE_HOME/bin
