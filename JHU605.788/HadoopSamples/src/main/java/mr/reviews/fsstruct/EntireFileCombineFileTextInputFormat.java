...
public class EntireFileCombineFileTextInputFormat extends CombineFileInputFormat<NullWritable, BytesWritable> {
    ...
    public RecordReader<NullWritable, BytesWritable> createRecordReader(InputSplit split, TaskAttemptContext context) throws IOException{
        return new CombineFileRecordReader<NullWritable, BytesWritable>(
                (CombineFileSplit)split, context, EntireFileCombineInputRecordReader.class);
    }
}
